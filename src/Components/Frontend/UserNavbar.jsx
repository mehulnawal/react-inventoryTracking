...
import {
    Package, User, Settings, Moon, Sun, Bell, ChevronDown, LogOut
} from 'lucide-react';
import { Outlet } from "react-router";

export const UserNavbar = ({ isDarkMode = false, onToggleDarkMode, user = { name: 'John Doe', email: 'john@company.com', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=40&h=40&fit=crop&crop=face' } }) => {
